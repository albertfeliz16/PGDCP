...
namespace PGDCP.Migrations
{
    ...
    [Migration("20260414055056_ActualizacionValoraciones")]
    partial class ActualizacionValoraciones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Conservacion", b =>
                {
                    ...
                    b.Property<decimal>("CostoIntervencion")
            ...
            modelBuilder.Entity("PGDCP.Models.AuditoriaLogin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PGDCP.Models.EstadoConservacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PGDCP.Models.LogCambio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LogCambios", (string)null);
                });
            ...
            modelBuilder.Entity("PGDCP.Models.Tecnica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PGDCP.Models.Valoracion", b =>
                {
                    ...
                    b.Property<string>("EstadoAutenticidad")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FactoresAjuste")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Conservacion", b =>
                {
                    b.HasOne("PGDCP.Models.EstadoConservacion", null)
                        .WithMany("Conservaciones")
            ...
            modelBuilder.Entity("PGDCP.Models.Obra", b =>
                {
                    ...
                    b.HasOne("PGDCP.Models.Tecnica", "Tecnica")
                        .WithMany("Obras")
