...
namespace PGDCP.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            var existe = await _userManager.FindByEmailAsync(Input.NewEmail);
            if (existe != null)
            {
                StatusMessage = "Error: ese correo ya está en uso por otro usuario.";
                return RedirectToPage();
            }

            // Cambio directo sin confirmación por correo
            ...
            StatusMessage = "Correo actualizado correctamente.";
            return RedirectToPage();
        }
