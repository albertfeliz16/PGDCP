        ...
        public async Task<IActionResult> Index()
        {
            if (User.Identity?.IsAuthenticated == true)
            {
                ...
                ViewBag.ValorTotal = isAdmin
                    ...
                    : await _context.Obras.Where(o => o.UserId == userId)
                        .SumAsync(o => (decimal?)o.ValorEstimado) ?? 0;

                // ── Include Epoca para poder usar obra.Epoca.Nombre en la vista ──
                ViewBag.ObrasRecientes = isAdmin
                    ? await _context.Obras
                        .Include(o => o.Epoca)
                        .Include(o => o.Categoria)
                        .OrderByDescending(o => o.FechaAdquisicion)
                        .Take(5).ToListAsync()
                    : await _context.Obras
                        .Include(o => o.Epoca)
                        .Include(o => o.Categoria)
                ...
                if (User.IsInRole("Restaurador"))
                    ViewBag.UltimasConservaciones = await _context.Conservaciones
                        .Include(c => c.Obra)
                        .OrderByDescending(c => c.FechaIntervencion)
                        .Take(5).ToListAsync();
